                ...
                <div class="table attendance-table" id="attendaceTable">
                    <table>
                        <thead>
                            <tr>
                                ...
                                if ($distinctDatesResult) {
                                    ...
                                    echo "<th>No attendance taken yet</th>";
                                }
                                ?>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            $studentsQuery = "SELECT registrationNumber FROM tblstudents WHERE courseCode = :courseCode";
                            ...
                            foreach ($studentRows as $row) {
                                ...
                                if ($distinctDatesResult) {
                                    foreach ($distinctDatesResult as $dateRow) {
                                        ...
                                        // Display attendance status or default to "Not Marked"
                                        if ($attendanceResult) {
